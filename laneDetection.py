...
def readVideo():
    ...
    inpImage = cv2.VideoCapture(os.path.join(CWD_PATH, 'trackVideo.mp4'))
...
def slide_window_search(binary_warped, histogram):
    ...
    #iterates trough windows and searhes for lane lines
...
#general search methos to detect curves
...
#determine deviation from the center
